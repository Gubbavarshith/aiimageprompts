        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-[2fr_1fr] gap-8 lg:gap-12">
            ...
            <div>
              ...
              {/* Title */}
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-black dark:text-white leading-[1.1] mb-6 tracking-tight">
                {prompt.title}
              </h1>

              {/* SEO Intro Paragraph */}
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Discover the perfect AI image prompt for creating stunning <strong>{prompt.category.toLowerCase()}</strong> visuals. 
                This carefully crafted <em>{prompt.title.toLowerCase()}</em> prompt is optimized to generate high-quality, professional results 
                using modern AI image generators. Whether you're an artist, designer, or creator, use this prompt as a foundation for your next masterpiece.
              </p>
              ...
              {/* SEO Content: Best Models & Settings */}
              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 dark:bg-zinc-950 border-2 border-black dark:border-white rounded-xl p-6">
                  <h3 className="font-bold text-lg mb-3">Best AI Models to Use</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    This prompt performs exceptionally well with <strong>Midjourney v6</strong> for photorealism and cinematic aesthetics, <strong>DALL-E 3</strong> for precise prompt adherence, and <strong>Stable Diffusion XL (SDXL)</strong> for customized control.
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-950 border-2 border-black dark:border-white rounded-xl p-6">
                  <h3 className="font-bold text-lg mb-3">Recommended Settings</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    For optimal results, keep stylize values moderate (e.g., <code>--s 250</code> in Midjourney). If using negative prompts, emphasize avoiding blurry or distorted features. The recommended aspect ratio is <strong>{prompt.image_ratio}</strong>.
                  </p>
                </div>
              </div>

              {/* SEO Content: Style & Improvement */}
              <div className="mb-8 space-y-6">
                <div>
                  <h3 className="text-xl font-bold mb-3">Style Explanation</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    This prompt leverages the <strong>{prompt.category}</strong> aesthetic, focusing on specific lighting, compositional techniques, and subject framing to achieve a professional look. The keyword combinations are structured to prioritize the primary subject while establishing a cohesive environmental mood.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-3">How to Improve This Prompt</h3>
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    To make this prompt your own, consider modifying the lighting keywords (e.g., changing "golden hour" to "neon cyberpunk lighting") or adjusting the camera parameters. Adding specific color grading terms like "teal and orange" or "high contrast black and white" can drastically alter the final output's atmosphere.
                  </p>
                </div>
              </div>
              ...
              {/* SEO Content: FAQs */}
              <div className="mb-12">
                <h2 className="text-2xl font-black mb-6 border-b-2 border-gray-100 dark:border-zinc-800 pb-2">
                  Frequently Asked Questions
                </h2>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-black border border-gray-200 dark:border-zinc-800 rounded-lg p-5">
                    <h3 className="font-bold text-lg mb-2">Can I use this AI image prompt for commercial projects?</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                      Generally, yes. Images generated by most major AI tools (like Midjourney, DALL-E 3) using this prompt can be used commercially, depending on your subscription tier with the respective AI service. Always check the specific platform's terms of service.
                    </p>
                  </div>
                  <div className="bg-white dark:bg-black border border-gray-200 dark:border-zinc-800 rounded-lg p-5">
                    <h3 className="font-bold text-lg mb-2">Why isn't my generated image looking exactly like the preview?</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                      AI image generation is inherently probabilistic. Even with the exact same prompt and settings, the AI will produce variations. To get closer to the preview, ensure you are using the same AI model, aspect ratio ({prompt.image_ratio}), and any specified negative prompts.
                    </p>
                  </div>
                </div>
              </div>
