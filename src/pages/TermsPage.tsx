...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { id: 'conduct', icon: Scale },
    { id: 'ip', icon: FileText },
    { id: 'disclaimer', icon: CircleHelp },
      ...
      <div className="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl">
            The guidelines and rules for using Aiimageprompts, so everyone can explore and create responsibly.
          </p>
            ...
            <div className="sticky top-32 space-y-1">
              ...
              {sections.map((section) => (
                ...
                >
                  ...
                  {section.id === 'acceptance' && 'Acceptance of terms'}
                  {section.id === 'usage' && 'Using Aiimageprompts'}
                  {section.id === 'conduct' && 'Community conduct'}
                  {section.id === 'ip' && 'Intellectual property'}
                  {section.id === 'disclaimer' && 'Disclaimers'}
          ...
          <div className="flex-1 prose prose-zinc dark:prose-invert max-w-none prose-headings:scroll-mt-32">
            <div id="acceptance" className="mb-16 scroll-mt-32">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                By accessing or using Aiimageprompts, you agree to these Terms of Use. If you do not agree, please do not use the site.
              </p>
            </div>
            ...
            <div id="usage" className="mb-16 scroll-mt-32">
              <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                ...
                Using Aiimageprompts
              </h2>
              <p className="text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed">
                Aiimageprompts is meant for inspiration, experimentation, and creative work with AI image models. When you use the site, you agree that:
              </p>
              <ul className="space-y-2 list-none pl-0">
                <li className="flex items-start gap-3 text-zinc-600 dark:text-zinc-400">
                  ...
                  You are responsible for how you use prompts and generated images, including compliance with any model or platform terms.
                </li>
                <li className="flex items-start gap-3 text-zinc-600 dark:text-zinc-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-black dark:bg-white mt-2 shrink-0" />
                  You will not use Aiimageprompts for illegal, harmful, or abusive purposes.
                </li>
                <li className="flex items-start gap-3 text-zinc-600 dark:text-zinc-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-black dark:bg-white mt-2 shrink-0" />
                  We may update, change, or remove features and content at any time.
                </li>
              </ul>
            </div>
            ...
            <div id="conduct" className="mb-16 scroll-mt-32">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                You agree not to upload, share, or generate content that is hateful, harassing, discriminatory, unlawful, or intended to cause harm. We reserve the right to remove content or restrict access at our discretion.
              </p>
            </div>
            ...
            <div id="ip" className="mb-16 scroll-mt-32">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                The Aiimageprompts website, design, and original content are owned by the project and its contributors. You may use prompts as creative input, but you may not copy and redistribute the site itself as a competing product.
              </p>
            </div>
            ...
            <div id="disclaimer" className="mb-16 scroll-mt-32">
              ...
              <div className="bg-zinc-100 dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
                <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed m-0">
                  Aiimageprompts is provided “as is” without warranties of any kind. We do not guarantee specific results from any prompt or integration with third‑party tools.
                </p>
              </div>
            </div>
            ...
            <div id="contact" className="mb-16 scroll-mt-32">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                If you have questions about these Terms of Use, reach out at{' '}
